...
INSERT INTO `homepage` VALUES ('discover_our_happy_clients','See our<strong>400</strong> happy customers and what they think'),('discover_wisembly_for','Use Wisembly for:'),('events','Events'),('formations','Trainings'),('homepage_baseline','Wisembly is a web & mobile solution that allows you to prepare, facilitate and monitor your meetings.'),('homepage_poll_choice_1','Concrete figures'),('homepage_poll_choice_2','A clear overall vision'),('homepage_poll_choice_3','An accurate roadmap'),('homepage_poll_question','What do you expect from today\'s presentation?'),('homepage_slide_info','Updated in real time'),('homepage_title','Work together in meetings'),('meetings','Meetings'),('quote_dias','Everybody loved it – it’s a brand new way to contribute [...]Wisembly lets you go beyond the presentation and open a dialog.'),('testimonials','Testimonials');
